...
#' @param density Numeric. Passed to [texPreview::tex_preview] to control the
#'   density of the image for non-pdf documents. Can be set as a chunk option.
#' @param fig.path Path to store figures.
#' @param savedag Logical. Should the DAG be saved as an additional file? Can be
#'   set as a chunk option.
#' @param label When saving images separately, will be named with the current
#'   chunk label.
#' @param printdag Logical. Should the DAG be printed? Can be set as a chunk
#'   option.
#' @param is_latex_code Logical. Can be used to pass the code generated by
#'   [get_latex_code()] directly.
#' @param is_swig Logical. Does the TikZ library for SWIGs need to be called?
#'   (Only needed if passing LaTeX code directly.)
